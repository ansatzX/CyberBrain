---
name: tachikoma-runner
package: cyberbrain
description: "Thin delegation runner that executes the tachikoma protocol against an external AI CLI and returns a narrow, evidence-backed conclusion without forwarding raw output."
systemPromptMode: replace
inheritProjectContext: true
inheritSkills: true
defaultContext: fresh
generatedFrom: plugins/awesome-agent-select/agent-profiles/tachikoma-runner.md
---
